...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const APIKEY = "679587742e4264831ed2397c";
    //getContacts();
    ...
    document.getElementById("contact-submit").addEventListener("click", function (e) {
      ...
      let genderValue = contactGender ? contactGender.value : ""; // Extract value or set empty if not selected
      ...
      let jsondata = {
        ...
        "gender": genderValue // Add gender to the JSON object
        };
      ...
      fetch("https://hnggg-15bd.restdb.io/rest/account?max=2", settings)
  ...
  //   function getContacts(limit = 11, all = true) {
  ...
  //     fetch(`https://fedassignment-6369.restdb.io/rest/user-account/${id}`, settings)
  //       .then(response => response.json())
  //       .then(data => {
  //         console.log(data);
  //         document.getElementById("update-contact-container").style.display = "none";
